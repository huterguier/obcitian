	...
	function addProperty(root, key, value, type) {
		...
		<div class="metadata-property"  tabindex="0" data-property-key="date" data-property-type="date">
			<div class="metadata-property-key">
				<span class="metadata-property-icon" aria-disabled="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-text"><path d="M17 6.1H3"></path><path d="M21 12.1H3"></path><path d="M15.1 18H3"></path></svg></span><input id="metadata-key-${key}" class="metadata-property-key-input" type="text" value="${key}">
			</div>
